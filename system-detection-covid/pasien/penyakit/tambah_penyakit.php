...
<section class="inner">
		...
		<div class="box">
				...
				<div class="panel-body">
					...
					<form method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							<label>foto</label>
							<input type="file" name="foto_penyaakit" class="form-control" required="">
						</div>
	...
	{
		$penyakit->simpan_penyakit($_POST['nama_penyakit'],$_POST['deskripsi_penyakit'],$_POST['pencegahan_penyakit'],$_FILES['foto_penyakit']);
