...
<section class="inner">
				...
				<div class="panel-body">
					...
					<form method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<input type="" class="form-control" name="nama_obat" value="<?php echo $data_penyakit['nama_obat']?>">
						</div>
						<div class="form-group">
							<label>Foto</label>
	...
	{
		$penyakit->ubah_penyakit($_POST['nama_penyakit'],$_POST['deskripsi_penyakit'],$_POST['pencegahan_penyakit'], $_POST['nama_obat'], $_FILES['foto_penyakit'],$id_penyakit);
