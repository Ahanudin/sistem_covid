	...
	<div class="form-body wow fadeIn animated">
		<div class="box">
				...
				<div class="panel-body">
					<div class="inner">
						<?php
						$data_rekam_medis = $rekam_medis->tampil_rekam_medis(); 
						?>
								...
								<?php foreach ($data_rekam_medis as $key => $value) : ?>
									<tr>
										...
										<td>
											...
											<a href="cetak.php?id_rekam_medis=<?php echo $value['id_rekam_medis'] ?>" class="btn btn-primary hidden-print">Print</a>
